...
public class TestProgramInvokeFactory implements ProgramInvokeFactory {
    ...
    @Override
    public ProgramInvoke createTopLevel(Transaction tx, int txindex, Block block, Repository repository, BlockStore blockStore) {
    ...
    public ProgramInvoke createInternal(Program program, DataWord toAddress, DataWord callerAddress,
                                        ...
                                        boolean isStaticCall, boolean byTestingSuite, CallGasLocker callGasLocker) {
        return null;
    }
